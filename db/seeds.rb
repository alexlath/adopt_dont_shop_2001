...
pet1 = Pet.create(image:        "http://www.petharbor.com/get_image.asp?RES=Detail&ID=A0671703&LOCATION=DDFL",
                  name:         "Kona",
...
pet2 = Pet.create(image:        "http://www.petharbor.com/get_image.asp?RES=Detail&ID=A0806639&LOCATION=DDFL",
                  name:         "Benji",
                  ...
                  shelter_id:   shelter1.id)
pet3 = Pet.create(image:        "https://g.petango.com/photos/2241/5832e7cd-0325-4037-85ac-d108d894dafd.jpg",
                  name:         "Molly",
...
pet4 = Pet.create(image:        "https://g.petango.com/photos/2241/74885045-edbc-482a-92fa-899149d08a71.jpg",
                  name:         "Pearl",
